...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_beds_category` WHERE id=$id";    
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_beds_category` SET `category_name`='$category_name' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_beds_category`(`category_name`) VALUES ('$add_cate')";
...
$query = "select * from furniture_beds_category order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_bed_cate.php?delete=<?php echo $row['id']; ?>">
