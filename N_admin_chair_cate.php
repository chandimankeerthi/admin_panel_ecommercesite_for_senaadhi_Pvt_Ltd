...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_chairs_sub_category` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_chairs_sub_category` SET `category_name`='$category_name' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_chairs_sub_category`(`category_name`) VALUES ('$add_cate')";   
...
$query = "select * from furniture_chairs_sub_category order by id asc";
