...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_clothing` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    $iden=$_REQUEST['iden'];    
    $clothing_style=$_REQUEST['clothing_style'];  
     
    $sql="UPDATE `fashion_clothing` SET `clothing_style`='$clothing_style' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_clothing`(`clothing_style`) VALUES ('$add_cate')";
...
$query = "select * from fashion_clothing order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['clothing_style'] ?>"
                                                        name="clothing_style">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_clothing_style.php?delete=<?php echo $row['id']; ?>">
