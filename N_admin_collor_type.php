...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_collar_type` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_collar_type` SET `collar_type`='$coll' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_collar_type`(`collar_type`) VALUES ('$add_cate')";
...
$query = "select * from fashion_collar_type order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['collar_type'] ?>"
                                                        name="coll">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_collor_type.php?delete=<?php echo $row['id']; ?>">
