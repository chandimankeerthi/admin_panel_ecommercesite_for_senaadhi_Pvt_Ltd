...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_desk_chair_type` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_desk_chair_type` SET `type`='$type' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_desk_chair_type`(`type`) VALUES ('$add_cate')";
...
$query = "select * from furniture_desk_chair_type order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_desk_chair_type.php?delete=<?php echo $row['id']; ?>">
