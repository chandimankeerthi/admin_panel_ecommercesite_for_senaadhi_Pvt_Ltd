...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_color_familiy` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_color_familiy` SET `color`='$color' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_color_familiy`(`color`) VALUES ('$add_cate')";
...
$query = "select * from fashion_color_familiy order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_fashion_color_cate.php?delete=<?php echo $row['id']; ?>">
