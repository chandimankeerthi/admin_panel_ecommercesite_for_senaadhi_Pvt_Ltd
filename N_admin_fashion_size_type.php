...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_size` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_size` SET `size`='$size' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_size`(`size`) VALUES ('$add_cate')";
...
$query = "select * from fashion_size order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['size'] ?>" name="size">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_fashion_size_type.php?delete=<?php echo $row['id']; ?>">
