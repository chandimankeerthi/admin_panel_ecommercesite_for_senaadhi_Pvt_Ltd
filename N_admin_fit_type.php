...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_fit_type` WHERE id=$id";   
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_fit_type` SET `fit_size`='$fittype' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_fit_type`(`fit_size`) VALUES ('$add_cate')";
...
$query = "select * from fashion_fit_type order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['fit_size'] ?>"
                                                        name="fittype">
                                                </td>
                                                <td class="min-width">
