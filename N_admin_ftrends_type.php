...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_trends` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    $iden=$_REQUEST['iden'];    
    $trend_name=$_REQUEST['trend_name'];  
     
    $sql="UPDATE `fashion_trends` SET `trend_name`='$trend_name' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_trends`(`trend_name`) VALUES ('$add_cate')";
...
$query = "select * from fashion_trends order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['trend_name'] ?>"
                                                        name="trend_name">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_ftrends_type.php?delete=<?php echo $row['id']; ?>">
