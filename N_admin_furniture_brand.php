...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_brands` WHERE id=$id";    
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_brands` SET `brand_name`='$brand' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_brands`(`brand_name`) VALUES ('$add_cate')";
...
$query = "select * from furniture_brands order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_furniture_brand.php?delete=<?php echo $row['id']; ?>">
