...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_color_family` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_color_family` SET `color_type`='$color_type' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_color_family`(`color_type`) VALUES ('$add_cate')";
...
$query = "select * from furniture_color_family order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['color_type'] ?>"
                                                        name="color_type">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_furniture_color_cate.php?delete=<?php echo $row['id']; ?>">
