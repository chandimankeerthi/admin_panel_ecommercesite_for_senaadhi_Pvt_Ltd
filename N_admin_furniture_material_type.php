...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_material` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_material` SET `type`='$type' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_material`(`type`) VALUES ('$add_cate')";
...
$query = "select * from furniture_material order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_furniture_material_type.php?delete=<?php echo $row['id']; ?>">
