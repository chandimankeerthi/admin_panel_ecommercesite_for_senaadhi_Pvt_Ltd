...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_linen_fabric` WHERE id=$id";
    $conn->query($sql);
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_linen_fabric` SET `fabric_type`='$fabric_type' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_linen_fabric`(`fabric_type`) VALUES ('$add_cate')";
...
$query = "select * from furniture_linen_fabric order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['fabric_type'] ?>"
                                                        name="fabric_type">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_linen_fabric_type.php?delete=<?php echo $row['id']; ?>">
