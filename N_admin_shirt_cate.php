...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_shirt_category` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_shirt_category` SET `category_type`='$cate' WHERE id=$iden";    
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_shirt_category`(`category_type`) VALUES ('$add_cate')";
                        ...
                        <div class="card-style mb-30">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputProductName" required required
                                        name="add_cate">
                                </div>
                                <div class="col-12">
...
$query = "select * from fashion_shirt_category order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['category_type'] ?>"
                                                        name="cate">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_shirt_cate.php?delete=<?php echo $row['id']; ?>">
