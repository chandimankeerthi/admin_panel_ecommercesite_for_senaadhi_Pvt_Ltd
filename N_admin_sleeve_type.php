...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_tee_sleeve` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_tee_sleeve` SET `tee_sleeve_length`='$sleevetype' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_tee_sleeve`(`tee_sleeve_length`) VALUES ('$add_cate')";
...
$query = "select * from fashion_tee_sleeve order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['tee_sleeve_length'] ?>"
                                                        name="sleevetype">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_sleeve_type.php?delete=<?php echo $row['id']; ?>">
