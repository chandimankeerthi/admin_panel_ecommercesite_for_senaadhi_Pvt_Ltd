...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_t_shirt_category` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_t_shirt_category` SET `category_type`='$cate' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_t_shirt_category`(`category_type`) VALUES ('$add_cate')";   
...
$query = "select * from fashion_t_shirt_category order by id asc";
                                        ...
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_tshirt_cate.php?delete=<?php echo $row['id']; ?>">
