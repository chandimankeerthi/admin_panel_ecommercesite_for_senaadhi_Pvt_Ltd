...
if(isset($_POST['update'])){
    ...
    // $sql="UPDATE `tshirt_details` SET `productPrice`=$price,`discountpercentage`=$disco,`productQuantity`=$quantity`,`stockStatus`='$stat',`trending`=' $trending' WHERE id=$iden";
    $conn->query($sql);
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <h6>Tee Necline Type</h6>
                                            </th>
                                            <th>
                                                <h6>Tee Sleeve Type</h6>
                                            </th>
                                            <th>
                                                <h6>Size</h6>
                                            </th>
...
$query = "select * from product_details where mainCat='T-shirt' order by id asc";
                    ...
                    if(mysqli_num_rows($result)>0){
                        while($row = mysqli_fetch_array($result)){
                            ...
                            <td class="min-width">
                                <p><?php echo $row['sleevetype'] ?></p>
                            </td>
                            <td class="min-width">
                                <p><?php echo $row['fitype'] ?></p>
                            </td>
                            <td class="min-width">
                                <p><?php echo $row['patterntype'] ?></p>
                            </td>
                            <td class="min-width">
                                <p><?php echo $row['collartype'] ?></p>
                            </td>
                            <td class="min-width">
                                <p><?php echo $row['tee_neckline'] ?></p>
                            </td>
                            <td class="min-width">
                                <p><?php echo $row['tee_sleeve'] ?></p>
                            </td>
                            <td class="min-width">
                            ...
                            <td class="min-width">
                                <p><?php echo $row['clothingmaterial'] ?></p>
                            </td>
                            <td class="min-width">
                            ...
                            <td class="min-width">
                                <p><?php echo $row['clothingstyle'] ?></p>
                            </td>
                            <td class="min-width">
                            ...
                            <td>
                                <div class="action">
                                    <a class="text-danger"
                                        href="N_admin_view_tshirt.php?delete=<?php echo $row['id']; ?>">
