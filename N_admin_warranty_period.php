...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `furniture_warranty_period` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `furniture_warranty_period` SET `period`='$period' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `furniture_warranty_period`(`period`) VALUES ('$add_cate')";
...
$query = "select * from furniture_warranty_period order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['period'] ?>"
                                                        name="period">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_warranty_period.php?delete=<?php echo $row['id']; ?>">
