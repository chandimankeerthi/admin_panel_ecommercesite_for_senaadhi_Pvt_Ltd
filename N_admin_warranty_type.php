...
if(isset($_REQUEST['delete'])){
    $id=$_REQUEST['delete'];
    $sql="DELETE FROM `fashion_warranty_type` WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE `fashion_warranty_type` SET `warranty_type`='$cate' WHERE id=$iden";
...
if(isset($_REQUEST['AddDetails'])){    
    ...
    $sqlAddCat="INSERT INTO `fashion_warranty_type`(`warranty_type`) VALUES ('$add_cate')";
...
$query = "select * from fashion_warranty_type order by id asc";
                        ...
                        while($row = mysqli_fetch_array($result)){
                                        ?><form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                            <tr>
                                                ...
                                                <td class="min-width">
                                                    <input type="text" value="<?php echo $row['warranty_type'] ?>"
                                                        name="cate">
                                                </td>
                                                <td class="min-width">
                                                ...
                                                <td>
                                                    <div class="action">
                                                        <a class="text-danger"
                                                            href="N_admin_warranty_type.php?delete=<?php echo $row['id']; ?>">
