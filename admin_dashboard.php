        ...
        <nav class="sidebar-nav">
            <div class="col-lg-4">
                <a href="index.html" class="text-decoration-none">
                    <img src="assets/images/invoice/senadhinew2.png" style="height: 130px; margin-left: 60px;">
                </a>
            </div>
            <ul>
                <li class="nav-item">
                    <a href="view_site_admin.html">
                        <span class="icon">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            </svg>
                        </span>
                        <span class="text"> <b>View Site</b> </span>
                    </a>
                </li>
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_1" class="collapse dropdown-nav">
                        <li>
                            <a href="settings.html"> Sales</a>
                        </li>
                        <li>
                            <a href="blank-page.html"> Inventories </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_2" class="collapse dropdown-nav">
                        <li>
                            <a href="fashion_item_admin.html"> Fashion Items </a>
                        </li>
                        <li>
                            <a href="furniture_item_admin.html"> Furniture Items </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_3" class="collapse dropdown-nav">
                        <li>
                            <a href="fashion_cate_admin.html"> Fashion Categories </a>
                        </li>
                        <li>
                            <a href="furniture_cate_admin.html"> Furniture Categories </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="invoice_admin.html">
                        <span class="icon">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
