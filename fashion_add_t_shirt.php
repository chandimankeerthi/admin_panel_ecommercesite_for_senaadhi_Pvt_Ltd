...
$tshirtecategorey=$_REQUEST['tshirtecategorey'];
...
$tee_neckline=$_REQUEST['tee_neckline'];
$tee_sleeve=$_REQUEST['tee_sleeve'];
$size=$_REQUEST['size'];
...
$sql="INSERT INTO `product_details`(`mainCat`,`sub_categorey`,`gendertype`,`brand`,`Productname`,`productPrice`,`discountpercentage`,`productQuantity`,`sleevetype`,`fitype`,`patterntype`,`collartype`,`tee_neckline`,`tee_sleeve`,`size`,`colorfamily`,`clothingmaterial`,`warrantytype`,`warrantyperiod`,`trendtype`,`clothingstyle`,`shipping_cost`,`productInfo`,`productDes`,`productImage1`,`productImage2`,`productImage3`,`stockStatus`,`trending`,`product_type`)
VALUES ('$mainCat','$tshirtecategorey','$gendertype','$brand','$Productname',$productPrice,$discountpercentage,$productQuantity,'$sleevetype','$fitype','$patterntype','$collartype','$tee_neckline','$tee_sleeve','$Size','$colorFamily','$clothingmaterial','$warrantytype','$warrantyperiod','$trendtype','$clothingstyle',$shipping_cost,'$productInfo','$productDes','$image1','$image2','$image3','$stockStatus','$trending','$product_type')";
...
<body>
    ...
    <main class="main-wrapper">
        ...
        <form class="row g-3" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
            ...
            <div class="col-md-4">
                <label for="tshirtecategorey" class="form-label">T-Shirts Category</label>
                <select class="form-select" aria-label="Default select example" name="tshirtecategorey">
                    <?php
$getCategory="SELECT distinct(category_type) FROM fashion_t_shirt_category";
...
?>
        ...
        ?>
            ...
            <div class="col-md-4">
                <label for="inputtee_neckline" class="form-label">Tee Neckline</label>
                <select class="form-select" aria-label="Default select example" name="tee_neckline">
                    <?php
$getCategory="SELECT distinct(tee_neckline_type) FROM fashion_tee_neckline";
$resultSubCategory2=$conn->query($getCategory);
while($rowSub2 = $resultSubCategory2->fetch_array()){
?>
                    <option value="<?php echo $rowSub2['tee_neckline_type'] ?>">
                        <?php echo $rowSub2['tee_neckline_type'] ?>
                    </option>
                    <?php
}
        ?>
            ...
            <div class="col-md-4">
                <label for="inputtee_sleeve" class="form-label">Tee Sleeve Length</label>
                <select class="form-select" aria-label="Default select example" name="tee_sleeve">
                    <?php
$getCategory="SELECT distinct(tee_sleeve_length) FROM fashion_tee_sleeve";
$resultSubCategory2=$conn->query($getCategory);
while($rowSub2 = $resultSubCategory2->fetch_array()){
?>
                    <option value="<?php echo $rowSub2['tee_sleeve_length'] ?>">
                        <?php echo $rowSub2['tee_sleeve_length'] ?>
                    </option>
                    <?php
}
        ?>
