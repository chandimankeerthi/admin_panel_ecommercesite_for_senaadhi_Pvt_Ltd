...
if(isset($_REQUEST['InsertProduct'])){
    ...
    $trousercategorey=$_REQUEST['trousercategorey'];
...
if (isset($_POST['size']) && is_array($_POST['size'])) {
 ...
 $sql="INSERT INTO `product_details`(`mainCat`,`sub_categorey`,`gendertype`,`brand`,`Productname`,`productPrice`,`discountpercentage`,`productQuantity`,`patterntype`,`size`,`colorfamily`,`clothingmaterial`,`warrantytype`,`warrantyperiod`,`trendtype`,`clothingstyle`,`length`,`shipping_cost`,`productInfo`,`productDes`,`productImage1`,`productImage2`,`productImage3`,`stockStatus`,`trending`,`product_type`)
 VALUES ('$mainCat','$trousercategorey','$gendertype','$brand','$Productname',$productPrice,$discountpercentage,$productQuantity,'$patterntype','$Size','$colorFamily','$clothingmaterial','$warrantytype','$warrantyperiod','$trendtype','$clothingstyle','$length',$shipping_cost,'$productInfo','$productDes','$image1','$image2','$image3','$stockStatus','$trending','$product_type')";
...
<body>
    ...
    <main class="main-wrapper">
        ...
        <form class="row g-3" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
            ...
            <div class="col-md-4">
                <label for="inputstrousercategorey" class="form-label">Trouser Category</label>
                <select class="form-select" aria-label="Default select example" name="trousercategorey">
                    <?php
$getCategory="SELECT distinct(category_type) FROM fashion_trouser_category";
...
?>
        ...
        ?>
            ...
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" required name="discountpercentage" min="0" max="99">
            </div>
        ...
        ?>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" aria-label="Default select example" name="length">
                    <?php
$getCategory="SELECT distinct(length) FROM fashion_dress_length";
$resultSubCategory2=$conn->query($getCategory);
while($rowSub2 = $resultSubCategory2->fetch_array()){
?>
                    <option value="<?php echo $rowSub2['length'] ?>"><?php echo $rowSub2['length'] ?>
                    </option>
                    <?php
}
        ?>
